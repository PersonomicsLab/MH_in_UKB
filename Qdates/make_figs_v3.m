function [] = make_figs_v3(dirname,varargin)
...
for i=1:length(results_list)
    ...
    newvars = load(fullfile(dirname,varname),'corr_vals','tstep_new');
    ...
    f = plot_corr_vs_tframe(newvars.corr_vals,newvars.tstep_new,...
    ...
    if do_sig_tests
        [g,Z,P,t_short,t_long] = sig_corr_vs_tframe(newvars.corr_vals,...
            newvars.tstep_new,runvars.num_days_elapsed,...
        ...
        exportgraphics(g,[saveloc '_sig.png'],'Resolution',600)
    end    
end