...
% Age
n1 = strfind(H,'21003-3.0'); n1 = find(~cellfun(@isempty,n1));
...
% Head size
n1 = strfind(H,'25000-3.0'); n1 = find(~cellfun(@isempty,n1));
values = [values table2array(Conf(:,n1))]; clear n1
% Head motion rfMRI
n1 = strfind(H,'25741-3.0'); n1 = find(~cellfun(@isempty,n1));
values = [values table2array(Conf(:,n1))]; clear n1
% Head motion tfMRI
n1 = strfind(H,'25742-3.0'); n1 = find(~cellfun(@isempty,n1));
values = [values table2array(Conf(:,n1))]; clear n1
% Date
n1 = strfind(H,'53-3.0'); n1 = find(~cellfun(@isempty,n1));
...
save(sprintf('Confounds_Subjects_%s_scan2.mat',INPUT(10:end-4)),'conf');
dlmwrite(sprintf('Confounds_Subjects_%s_scan2.csv',INPUT(10:end-4)),conf,'precision',25);
